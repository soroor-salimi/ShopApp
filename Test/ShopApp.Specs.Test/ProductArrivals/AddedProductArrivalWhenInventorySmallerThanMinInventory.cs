...
namespace ShopApp.Specs.Test.ProductArrivals
{
    ...
    public class AddedProductArrivalWhenInventorySmallerThanMinInventory
        : BusinessIntegrationTest
    {
        ...
        [When("تعداد 5 تااز کالایی با عنوان شامپو با شماره فاکتور ۱۲۳a " +
        ...
        [Then("یک کالا با عنوان شامپو و حداقل موجودی ۱۰ و وضعیت اماده ی " +
            ...
            "  و موجودی5 باید در فهرست کالاها وجود داشته باشد")]
        ...
        public void Then()
        {
            ...
            expectProduct.Inventory.Should().Be(5);
