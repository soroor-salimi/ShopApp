...
namespace ShopApp.Specs.Test.ProductArrivals
{
    ...
    public class AddedProductArrivalWhenAvalable : BusinessIntegrationTest
    {
        ...
        [When("تعداد 20 تااز کالایی با عنوان شامپو با شماره فاکتور ۱۲۳a " +
        ...
        [Then("یک کالا با عنوان شامپو و حداقل موجودی ۱۰ و وضعیت موجود " +
            " در گروه بهداشتی " +
            "  و موجودی20 باید در فهرست کالاها وجود داشته باشد")]
