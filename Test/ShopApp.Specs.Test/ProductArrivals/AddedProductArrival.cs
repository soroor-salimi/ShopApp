...
namespace ShopApp.Specs.Test.ProductArrivals
{
    ...
    public class AddedProductArrival : BusinessIntegrationTest
    {
        ...
        [When("تعداد ۲۰ تا از کالایی با عنوان شامپو با شماره فاکتور a۱۲۳" +
        ...
        [And("یک ورودی کالا برای کالای شامپو در" +
            " تاریخ 1402/09/19 21:59  " +
            "و تعداد ۲۰ و شماره فاکتور ۱۲۳a و نام شرکت فپکو" +
            " باید در فهرست ورودی های کالا وجود داشته باشد")]
        public void Then()
        {
            var expect = ReadContext.Set<ProductArrival>().Single();
            expect.NameCompany.Should().Be("فپکو");
            expect.NumberOfInvoice.Should().Be("123a");
            expect.Count.Should().Be(20);
            ...
            expectProduct.Inventory.Should().Be(_productDto.Inventory);
